...
def decryptContent(password: str, username: str) -> str:
    ...
    decryptedContent = decryptor.update(encryptedData) + decryptor.finalize()
...
if __name__ == "__main__":
    encryptContent("[{'test'}]","password","username")
    values = decryptContent("password", "username")
    #print(values)
    values += "newContent"
    #print(values)
    encryptContent(values, "password", "username")
    values = decryptContent("password", "username")
    #print(values)
    #print(json.loads(values.replace("'", "\"")))
